# StackFast + TechStack Explorer Integration Plan (Backlog)

> **Status:** Historical backlog document from the pre-rebuild era.
> Preserved here because it captures useful data-model mapping ideas and
> success metrics that may be relevant to post-MVP work. Not an active
> plan — the canonical plan is the `ROADMAP.md` at the repo root.
